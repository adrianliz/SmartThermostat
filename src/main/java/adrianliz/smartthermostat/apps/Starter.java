...
import adrianliz.smartthermostat.apps.temperatures.backend.TemperaturesBackendApplication;
...
public class Starter {
  ...
  private static HashMap<String, Class<?>> applications() {
    ...
    applications.put("temperatures_backend", TemperaturesBackendApplication.class);
  ...
  private static HashMap<String, HashMap<String, Class<?>>> commands() {
    ...
    commands.put("temperatures_backend", TemperaturesBackendApplication.commands());
