...
public final class TemperatureResponseMother {
	public static TemperatureResponse create(TemperatureId id, SensorId sensorId,
											 Celsius celsiusRegistered, Timestamp timestamp) {
	...
	public static TemperatureResponse random() {
		return create(TemperatureIdMother.random(), SensorIdMother.random(),
				CelsiusMother.random(), TimestampMother.random());
	}
}
